...
# версия 2.0 умеет получать данные нескольких устройства по имени из нескольких KSC
# версия 2.1 умеет 2FA KSC. Для 2FA используется токен, срок жизни которого 3 минуты (инфа из документации)
